...
getRoutes (_, _, merchantOpCityId) req = do
  Maps.getRoutes merchantOpCityId req
...
getPickupRoutes (_, _, merchantOpCityId) req = do
  Maps.getPickupRoutes merchantOpCityId req
...
getTripRoutes (_, _, merchantOpCityId) req = do
  Maps.getTripRoutes merchantOpCityId req
