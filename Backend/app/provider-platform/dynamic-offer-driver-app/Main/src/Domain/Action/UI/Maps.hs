      ...
      case myGeohash of
        Just geoHash -> do
          ...
          if null placeNameCache
            then callMapsApi merchantOpCityId req merchant.geoHashPrecisionValue
            else pure $ map convertToGetPlaceNameResp placeNameCache
        Nothing -> callMapsApi merchantOpCityId req merchant.geoHashPrecisionValue
...
callMapsApi :: ServiceFlow m r => Id DMOC.MerchantOperatingCity -> Maps.GetPlaceNameReq -> Int -> m Maps.GetPlaceNameResp
callMapsApi merchantOpCityId req geoHashPrecisionValue = do
  res <- Maps.getPlaceName merchantOpCityId req
