...
verifyPerson :: (HasEsqEnv m r, Redis.HedisFlow m r, HasField "authTokenCacheExpiry" r Seconds, MonadFlow m) => RegToken -> m (Id Person.Person, Id Merchant.Merchant, Id DMOC.MerchantOperatingCity)
verifyPerson token = do
  ...
  case result of
    ...
    Nothing -> do
      ...
      let merchantOperatingCityId = Id se.merchantOperatingCityId
