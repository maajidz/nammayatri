...
findByMerchantOpCityId :: (MonadFlow m, CacheFlow m r) => Id MerchantOperatingCity -> m (Maybe TransporterConfig)
...
updateFCMConfig :: MonadFlow m => Id MerchantOperatingCity -> BaseUrl -> Text -> m ()
updateFCMConfig = Queries.updateFCMConfig

updateReferralLinkPassword :: MonadFlow m => Id MerchantOperatingCity -> Text -> m ()
