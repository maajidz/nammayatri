...
whatsAppOptAPI (personId, merchantId, merchantOperatingCityId) = withFlowHandlerAPI . withPersonIdLogTag personId . DWhatsapp.whatsAppOptAPI (personId, merchantId, merchantOperatingCityId)
