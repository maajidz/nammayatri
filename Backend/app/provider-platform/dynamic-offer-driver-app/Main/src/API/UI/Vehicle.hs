...
getVehicle (personId, merchantId, merchantOperatingCityId) registrationNoM = withFlowHandlerAPI . DVehicle.getVehicle (personId, merchantId, merchantOperatingCityId) registrationNoM
