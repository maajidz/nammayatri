...
createDriverReferral (driverId, merchantId, merchantOperatingCityId) = withFlowHandlerAPI . Domain.createDriverReferral (driverId, merchantId, merchantOperatingCityId) False
