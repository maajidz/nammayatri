...
rating :: (Id Person.Person, Id Merchant.Merchant, Id DMOC.MerchantOperatingCity) -> DFeedback.FeedbackReq -> App.FlowHandler APISuccess
rating (personId, _, _) request = withFlowHandlerAPI . withPersonIdLogTag personId $ do
