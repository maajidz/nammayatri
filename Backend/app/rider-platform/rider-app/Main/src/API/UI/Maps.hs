...
autoComplete (personId, merchantId, merchantOperatingCityId) = withFlowHandlerAPI . withPersonIdLogTag personId . DMaps.autoComplete merchantId merchantOperatingCityId
