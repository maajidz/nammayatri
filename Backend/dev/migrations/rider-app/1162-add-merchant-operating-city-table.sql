...
-- Add the new column
ALTER TABLE atlas_app.merchant_service_usage_config ADD COLUMN merchant_operating_city_id character(36) REFERENCES atlas_app.merchant_operating_city(id);
ALTER TABLE atlas_app.merchant_service_config ADD COLUMN merchant_operating_city_id character(36) REFERENCES atlas_app.merchant_operating_city(id);
...
SET merchant_operating_city_id = merchant_operating_city.id
FROM atlas_app.merchant_operating_city
WHERE atlas_app.merchant_service_config.merchant_id = merchant_operating_city.merchant_id;
...
ALTER TABLE atlas_app.search_request ADD COLUMN merchant_operating_city_id character(36) NOT NULL REFERENCES atlas_app.merchant_operating_city(id);

ALTER TABLE atlas_app.booking ADD COLUMN merchant_operating_city_id character(36) NOT NULL REFERENCES atlas_app.merchant_operating_city(id);

ALTER TABLE atlas_app.estimate ADD COLUMN merchant_operating_city_id character(36)  REFERENCES atlas_app.merchant_operating_city(id) ;
ALTER TABLE atlas_app.driver_offer ADD COLUMN merchant_operating_city_id character(36)  REFERENCES atlas_app.merchant_operating_city(id) ;
ALTER TABLE atlas_app.quote ADD COLUMN merchant_operating_city_id character varying(36) NOT NULL REFERENCES atlas_app.merchant_operating_city (id);
ALTER TABLE atlas_app.ride ADD COLUMN merchant_operating_city_id character(36)  REFERENCES atlas_app.merchant_operating_city(id) ;
