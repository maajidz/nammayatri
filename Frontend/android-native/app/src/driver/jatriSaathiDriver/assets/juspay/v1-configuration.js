window.getMerchantConfig = function () {
  return JSON.stringify({
    ...
    "StringKeys": ["WELCOME_TEXT", "ABOUT_TEXT", "NEED_IT_TO_ENABLE_LOCATION", "CURRENTLY_WE_ALLOW_ONLY_KARNATAKA_REGISTERED_NUMBER", "YOU_ARE_ABOUT_TO_CALL_NAMMA_YATRI_SUPPORT", "YOUR_LOCATION_HELPS_OUR_SYSTEM", "EARNED_ON_APP", "TRAVELLED_ON_APP", "REPORT_ISSUE_CHAT_PLACEHOLDER", "NAMMA_YATRI_PLANS", "ENJOY_THESE_BENEFITS"],
    "fontType": "Assets",
    "currency": "₹",
    "isGradient" : "false",
    "BONUS_EARNED" : "false",
