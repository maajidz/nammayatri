...
const englishStrings = {
  ...
  LOGO: "Logo",
  ABOUT_APP_DESCRIPTION: "Novo partner is an open platform to connect drivers with riders. The app makes it convenient for drivers to find riders with proposed desired rates. No ride based commission, just pay small amount in the form of monthly subscription",
  ...
  NEED_IT_TO_ENABLE_LOCATION: "Novo Partner collect location data to enable share your location to monitor driver current location, even when the app is closed or not in use.",
  ...
  BONUS_PRIMARY_TEXT : "Novo Bonus is the  additional amount you have  earned above the meter charge in the form of pickup charges,  customer tips and driver additions.",
  BONUS_SECONDARY_TEXT : "The Novo Bonus amount is part of your total earnings.",
  ...
  YOU_ARE_ABOUT_TO_CALL_NAMMA_YATRI_SUPPORT: "You are about to place a call to the NovoSupport Team. Do you want to proceed?",
  ...
  CORPORATE_ADDRESS_DESCRIPTION : "Novo Cabs Private Limited <br> First Floor, Hotel Royal Samad, Munawar Link Road, Bishember Nagar, Munawara Abad, Srinagar, Jammu and Kashmir 190001",
  CORPORATE_ADDRESS_DESCRIPTION_ADDITIONAL :  "Website: <u>https://novocabs.com/</u>",
  REGISTERED_ADDRESS : "Registered Address",
  REGISTERED_ADDRESS_DESCRIPTION : "Novo Cabs Private Limited <br> First Floor, Hotel Royal Samad, Munawar Link Road, Bishember Nagar, Munawara Abad, Srinagar, Jammu and Kashmir 190001",
  REGISTERED_ADDRESS_DESCRIPTION_ADDITIONAL : "Website: <u>https://novocabs.com/</u>",
  ...
  TO_CONTINUE_USING_YATRI_SATHI : "To continue usin Novo, please complete your payment for",
  PAY : "Pay",
  LATER : "Later",
  GREAT_JOB : "Great Job!",
  YOU_HAVE_COMPLETED_RIDES_YESTERDAY : "You have completed X Rides yesterday!",
  FEE_BREAKUP : "Fee breakup",
  YATRI_SATHI_FEE_PAYABLE_FOR_DATE : "Novo fee payable for",
  ...
  PAYMENT_FAILED_DESC : "You may retry payment, or make the payment at your nearest Novo booth",
  ...
  AADHAAR_LINKING_REQUIRED_DESCRIPTION : "To start driving for Novo, please \n link your Aadhaar ID",
  ...
  PAYMENT_PENDING_ALERT_DESC : "To continue taking rides on Novo, clear your payment dues",
  LOW_ACCOUNT_BALANCE : "Low Account Balance",
  LOW_ACCOUNT_BALANCE_DESC : "Your bank account balance is low. Add money to enjoy uninterrupted rides.",
