            ...
            , linearLayout
                ...
                , visibility if config.postImgVisibility then VISIBLE else GONE
                    ...
                    , margin (MarginRight 2)
                        ...
                        [ height $ V 13
                        , width $ V 13
                        , imageWithFallback if ((fromMaybe 0.0 state.data.analyticsData.rating) - item < -0.50) then "ny_ic_star_inactive," <> (getCommonAssetStoreLink FunctionCall) <> "ny_ic_star_inactive.png" 
                                              else if ((fromMaybe 0.0 state.data.analyticsData.rating) - item >= 0.00) then "ny_ic_star_active," <> (getCommonAssetStoreLink FunctionCall) <> "ny_ic_star_active.png"
