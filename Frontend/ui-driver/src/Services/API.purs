...
data GetRidesSummaryListReq = GetRidesSummaryListReq String String String
...
instance makeGetRidesSummarListReq :: RestEndpoint GetRidesSummaryListReq GetRidesSummaryListResp where
    makeRequest reqBody@(GetRidesSummaryListReq status fromDay toDay) headers = defaultMakeRequest GET (EP.getRidesSummaryList status fromDay toDay) headers reqBody Nothing
    decodeResponse = decodeJSON
    encodeRequest req = defaultEncode req
