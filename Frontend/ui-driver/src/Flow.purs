...
setProfileImage url = do
  ...
  case resp of
    Right (ImageFromUrlResp image) -> setValueToLocalStore DRIVER_PROFILE_IMAGE image
    Left err -> pure unit
