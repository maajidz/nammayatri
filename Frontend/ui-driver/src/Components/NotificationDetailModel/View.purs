...
import Engineering.Helpers.Commons (flowRunner, getNewIDWithTag, screenWidth, getVideoID)
                                  ...
                                  , onAnimationEnd
                                      ( \action -> do
                                          let
                                            ...
                                            url = state.mediaUrl
                                          case mediaType of
                                            VideoLink -> pure $ runFn3 setYoutubePlayer (youtubeData state "VIDEO" 0 ) id (show PLAY)
                                            PortraitVideoLink -> pure $ runFn3 setYoutubePlayer (youtubeData state "PORTRAIT_VIDEO" 0 ) id (show PLAY)
...
youtubeData :: NotificationDetailModelState -> String -> Int -> YoutubeData
youtubeData state mediaType height =
  { videoTitle: "title"
  , setVideoTitle: false
