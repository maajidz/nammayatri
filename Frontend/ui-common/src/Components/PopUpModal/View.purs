...
import Engineering.Helpers.Commons (screenHeight, screenWidth, getNewIDWithTag, getVideoID)
...
import JBridge (startTimerWithTime, setYoutubePlayer)
                ...
                , width state.coverVideoConfig.width
                    ...
                    , onAnimationEnd
                        ( \action -> do
                            ...
                            case mediaType of
                                "VideoLink" -> pure $ runFn3 setYoutubePlayer (youtubeData state.coverVideoConfig "VIDEO") id (show PLAY)
                                "PortraitVideoLink" -> pure $ runFn3 setYoutubePlayer (youtubeData state.coverVideoConfig "PORTRAIT_VIDEO") id (show PLAY)
                                _ -> pure unit
                        )(const NoAction)
                    ][]
                  ]
