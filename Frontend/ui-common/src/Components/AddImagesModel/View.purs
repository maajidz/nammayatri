...
import JBridge (renderBase64ImageFile)
   ...
   , gravity CENTER
    ...
    , orientation VERTICAL
                      ...
                      , imageView
                          ...
                          , imageWithFallback ("ny_ic_round_cross," <> (getCommonAssetStoreLink FunctionCall) <> "ny_ic_round_cross")
                          , onClick push (case state.isLoading of
      ...
      , cornerRadius 10.0
       ...
       , imageWithFallback ("ny_ic_add_unfilled," <> (getCommonAssetStoreLink FunctionCall) <> "ny_ic_add_unfilled")
       ]
       , textView
