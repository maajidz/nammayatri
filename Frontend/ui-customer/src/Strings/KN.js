...
const kannadaStrings = {
  ...
  "LEARN_ABOUT_NAMMA_SAFETY" : "Learn about Namma Safety",
  "NAMMA_SAFETY_WILL_ENABLE_ACCESS" : "Namma Safety will enable access to the following features during a ride!",
  "EDIT_ACTIONS" : "Edit Actions",
  "EMERGENCY_ACTIONS" : "Emergency Actions",
  "WHEN_YOU_START_EMERGENCY_SOS" : "When you start Emergency SOS, your app will perform the below actions",
  ...
  "ABOUT_SOS_DESC" : "Kindly understand the criticality of SOS. For non-critical situations, kindly use the <b>Help & Support</b> section to raise a complaint.",
  "FEW_EXAMPLES_OF_SOS_SITUATIONS" : "Few examples of SOS situations",
  "THINGS_TO_DO_DURING_SOS_SITUATION" : "Things to do during SOS situation",
  "EMERGENCY_REQUEST_SENT" : "Emergency request Sent!",
  "SOS_TRIGGERED_DESC" : "Please stay calm, Your real time location is being shared with your emergency contacts and our support team",
  "SOS_ACTIONS" : "SOS Actions",
  "CALL_POLICE" : "Call Police<br>(112)",
  "CALL_SUPPORT" : "Call Our<br>Support",
  "RECORD_VIDEO" : "Record<br>Video",
  ...
  "NAMMA_SAFETY_MEASURES" : "Namma Safety Measures",
  ...
  "SHARE_INFO_WITH_EMERGENCY_CONTACTS_DESC" : "On SOS, the ride information will be auto shared with the below emergency contacts.",
  ...
  "ENABLE_NIGHT_TIME_SAFETY_ALERTS_DESC" : "To ensure your safety, from 9 PM-6AM, we would send safety check alerts basis anomaly detection. In cases of route-deviation or when the vehicle is not moving",
  "ALMOST_DONE_TITLE" : "Almost Done!",
  "ALMOST_DONE_DESC" : "During SOS, based on the criticality of situation, any of these options can be selected\n\n • Call 112\n • Call NammaYatri support\n • Record video",
  "SAFETY_MEASURE_1" : "Night-time safety check based on ride anomaly detection",
  "SAFETY_MEASURE_2" : "24/7 dedicated NammaSafety support",
  "SAFETY_MEASURE_3" : "SOS Namma Safety button.",
  "SAFETY_MEASURE_4" : "Zero tolerance policy for drivers/customers",
  "SAFETY_MEASURE_5" : "Customer privacy - drivers can't view the exact address of the ride once completed",
  ...
  "SAFETY_GUIDELINES_6" : "Use In-App emergency Namma Safety feature",
  ...
  "ABOUT_SOS_9" : "Activate SOS by clicking on Namma Safety button during the ride.",
  "ABOUT_SOS_10" : "Remain Calm. Do not panic.",
  "ABOUT_SOS_11" : "Inform your family & friends/ Namma Yatri support by emergency sharing.",
  "ABOUT_SOS_12" : "Choose an appropriate SOS option from: Call Police (112)/ Call Namma Yatri support/ Record video (to share with emergency contacts & Namma Yatri",
