...
getKeyString key = case key of
  ...
  PLACES_YOU_MIGHT_LIKE_TO_GO_TO -> "PLACES_YOU_MIGHT_LIKE_TO_GO_TO"
  SUGGESTED_DESTINATION -> "SUGGESTED_DESTINATION"
  RECENT_RIDES -> "RECENT_RIDES"
  ONE_CLICK_BOOKING_FOR_YOUR_FAVOURITE_JOURNEYS -> "ONE_CLICK_BOOKING_FOR_YOUR_FAVOURITE_JOURNEYS"
  VIEW_MORE -> "VIEW_MORE"
  VIEW_LESS -> "VIEW_LESS"
  HAVE_A_REFFERAL -> "HAVE_A_REFFERAL"
  YOUR_SUGGESTED_DESTINATIONS_AND_RECENT_RIDES_WILL_APPEAR_HERE -> "YOUR_SUGGESTED_DESTINATIONS_AND_RECENT_RIDES_WILL_APPEAR_HERE"
  WELCOME_TO_NAMMA_YATRI_ -> "WELCOME_TO_NAMMA_YATRI_"
  BOOK_AND_MOVE -> "BOOK_AND_MOVE"
  ANYWHERE_IN_THE_CITY -> "ANYWHERE_IN_THE_CITY"
  CHECKOUT_OUR_LIVE_STATS -> "CHECKOUT_OUR_LIVE_STATS"
  BENGALURU_MOST_LOVED_APP -> "BENGALURU_MOST_LOVED_APP"
  PICKUP_ -> "PICKUP_"