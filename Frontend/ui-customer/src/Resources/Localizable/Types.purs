...
getKeyString key = case key of
  STILL_HAVING_ISSUE -> "STILL_HAVING_ISSUE"
  ISSUE_MARKED_AS_RESOLVED -> "ISSUE_MARKED_AS_RESOLVED"
  ISSUE_RESOLVED_TEXT -> "ISSUE_RESOLVED_TEXT"
  ...
  CALL_DRIVER_TITLE -> "CALL_DRIVER_TITLE"
  CALL_SUPPORT_TITLE -> "CALL_SUPPORT_TITLE"
  CALL_DRIVER_DESCRIPTION -> "CALL_DRIVER_DESCRIPTION"
  CALL_SUPPORT_DESCRIPTION -> "CALL_SUPPORT_DESCRIPTION"
  ADD_IMAGE -> "ADD_IMAGE"
  ...
  YOUR_REPORTS -> "YOUR_REPORTS"
  I_DONT_KNOW_WHICH_RIDE -> "I_DONT_KNOW_WHICH_RIDE"
  SELECT_A_RIDE_TO_REPORT -> "SELECT_A_RIDE_TO_REPORT"
  RIDE_RELATED_ISSUE_PAGE_NAME -> "RIDE_RELATED_ISSUE_PAGE_NAME"
  APP_RELATED_ISSUE_PAGE_NAME -> "APP_RELATED_ISSUE_PAGE_NAME"
  DRIVER_RELATED_ISSUE_PAGE_NAME -> "DRIVER_RELATED_ISSUE_PAGE_NAME"
  LOST_AND_FOUND_ISSUE_PAGE_NAME -> "LOST_AND_FOUND_ISSUE_PAGE_NAME"
  YEARS_AGO -> "YEARS_AGO"
